	...
	*/
	...
	function addembed()
	{
	        ...
	        ?>
	                ...
	                <link rel='stylesheet' href='https://mmwebfonts.comquas.com/fonts/?font=<?php echo get_option('uniembed_font'); ?>'/>
	...
	?>
	                ...
	                body,html,p,code,*,table,td,tr,span,div,a,ul,li,input,textarea {
							...
							else if($font=="notosan")
	                        {
	                                echo "font-family:'Noto Sans Myanmar' !important;";
	                        }
	            else if($font=="zawgyi")
	            {
	...
	function unicode_rss($content) {
	        ...
	        if(is_feed())
	        {
	                $content="<span style=\"font-family:'Noto Sans Myanmar','MON3 Anonta 1','Masterpiece Uni Sans',Yunghkio,Myanmar3, Parabaik, Padauk, 'WinUni Innwa', 'Win Uni Innwa', 'MyMyanmar Unicode','Myanmar MN','Myanmar Sangam MN',Myanmar2;\">".$content."</span>";
	        }
	        return $content;
	}
